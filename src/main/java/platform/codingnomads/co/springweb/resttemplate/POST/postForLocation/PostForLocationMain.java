...
//            System.out.println(responseEntity.getHeaders().get("Location"));
            ...
            ResponseEntity<User> responseEntity = restTemplate
                    .getForEntity(returnedLocation, User.class);

            // Retrieving the posted user from the response entity
            User postedUser = responseEntity.getBody();

            // Printing information about the posted user
            System.out.println("Posted User: " + postedUser);
        };
    }
}
